...
public class TargetMapper {
    ...
    private final HashMap<Point, ArrayList<Point>> vertexToSet = new HashMap<>();
    private final HashMap<Color, Point> colorToVertex = new HashMap<>();

    public HashMap<Point, ArrayList<Point>> getVertexToSet() {
        return vertexToSet;
    }

    public HashMap<Color, Point> getColorToVertex() {
        return colorToVertex;
    }
